...
export function LandingHero() {
  return (
    <section className="relative overflow-hidden cinematic-hero pt-20 pb-24 lg:pt-28 lg:pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
          ...
          <div className="text-center lg:text-left animate-slide-up">
            <span className="cinematic-eyebrow inline-flex items-center gap-2">
              <span className="inline-block h-1.5 w-1.5 rounded-full bg-hero-accent animate-pulse" />
              ISSUE OPERATIONS PLATFORM
            </span>

            <h1 className="mt-6 font-display font-bold text-4xl sm:text-5xl lg:text-6xl leading-[1.02] tracking-tight text-white">
              Turn Every Operational Issue Into a{" "}
              <span className="text-hero-accent">Verified Resolution.</span>
            </h1>

            <p className="mt-6 max-w-xl text-base sm:text-lg lg:text-xl text-slate-300/90 mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <Link
                to="/book-demo"
                className={cn("btn-cinematic-primary px-7 py-3.5 text-base")}
              >
                Book a Demo
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-400/70">
          ...
          <div className="cinematic-product-shell animate-slide-up stagger-2">
            ...
            <div className="flex items-center gap-3 border-b border-white/[0.06] bg-white/[0.015] px-5 py-3">
              <div className="flex flex-1 items-center gap-2 rounded-md border border-white/[0.08] bg-white/[0.03] px-3 py-2 text-[12px] text-slate-500">
                <FiSearch className="h-4 w-4" />
                <span>Search issues, locations, assignees…</span>
              </div>
              <span className="rounded-md border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 text-[11px] text-slate-400">
                All Issues
              </span>
              <span className="rounded-md border border-hero-accent/30 bg-hero-accent/10 px-3 py-1.5 text-[11px] font-medium text-hero-accent">
                Assign
              </span>
            </div>
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="grid grid-cols-4 gap-3">
                {statCards.map((card) => (
                  <div
                    key={card.label}
                    className="rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3.5"
                  >
              ...
              <div className="mt-6 overflow-x-auto rounded-xl border border-white/[0.06] bg-white/[0.02]">
                <div className="flex items-center justify-between border-b border-white/[0.06] px-5 py-3">
                  <span className="text-sm font-semibold text-slate-100">Live Issues</span>
                ...
                <div className="border-b border-white/[0.06] px-5 py-3">
                  <div className="grid grid-cols-[4.5rem_1fr_auto_auto] items-center gap-4 text-[10px] font-semibold uppercase tracking-wider text-slate-500">
                    <span>ID</span>
                    <span>Issue</span>
                    <span>Status</span>
                ...
                <div className="divide-y divide-white/[0.04]">
                  {issues.map((issue) => (
                    ...
                    >
                      ...
                      <span className={cn("shrink-0", issue.badge)}>
                        {issue.status}
                      </span>
